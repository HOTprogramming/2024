...
public class Close3 extends AutonBase {
    ...
    public Pose2d shoot1 = new Pose2d(13.47, 6, Rotation2d.fromDegrees(90));
    public Pose2d ring2 = new Pose2d(13.47, 5.46, Rotation2d.fromDegrees(180));
    public Pose2d shoot2 = new Pose2d(13.47, 4.7, Rotation2d.fromDegrees(90));
    public Pose2d ring3 = new Pose2d(13.47, 4.11, Rotation2d.fromDegrees(180));
    public Pose2d shoot3 = new Pose2d(13.47, 2.5, Rotation2d.fromDegrees(90));
