...
public class AmpRedSpit extends AutonBase {
    ...
    Pose2d ring1 = new Pose2d(8.15, 7.3, Rotation2d.fromDegrees(165));
    Pose2d ring1for2first = new Pose2d(8.15, 7.3, Rotation2d.fromDegrees(175));
    ...
    Pose2d backStageRing = new Pose2d(14.34, 4.51, Rotation2d.fromDegrees(203));
    Pose2d stageRing = new Pose2d(14.05, 4.2, Rotation2d.fromDegrees(203));
