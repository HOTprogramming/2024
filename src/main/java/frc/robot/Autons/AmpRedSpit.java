...
public class AmpRedSpit extends AutonBase {
    ...
    Pose2d ring1 = new Pose2d(8.15, 7.6, Rotation2d.fromDegrees(165));
    Pose2d ring1for2first = new Pose2d(8.15, 7.6, Rotation2d.fromDegrees(175));

    Pose2d farShoot = new Pose2d(11.84, 6.3, Rotation2d.fromDegrees(170));
    Pose2d ring2 = new Pose2d(8.35, 5.77, Rotation2d.fromDegrees(194));
    Pose2d aroundStage = new Pose2d(10.75, 6.1, Rotation2d.fromDegrees(180));
    ...
    Pose2d ampRing = new Pose2d(13.67, 6.86, Rotation2d.fromDegrees(155));
    Pose2d backMidRing = new Pose2d(14.24, 5.5, Rotation2d.fromDegrees(180));
    Pose2d midPreback = new Pose2d(13.04, 5.5, Rotation2d.fromDegrees(180));
    // Pose2d backPreload = new Pose2d(1.9, 5.6, Rotation2d.fromDegrees(170));
    Pose2d backStageRing = new Pose2d(14.44, 4.61, Rotation2d.fromDegrees(203));
    Pose2d stageRing = new Pose2d(14.05, 4.26, Rotation2d.fromDegrees(203));
