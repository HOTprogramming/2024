...
public abstract class ConstantsBase {
    ...
    public ConstantsBase() {
        ...
        if (ROBOT_TYPE == RobotType.Comp) {
            ...
            constants = camBotConstants;
            iHateYou = camBotConstants.new IHateYou();
            kAuton = constants.new Auton();
            kAuton = constants.new Auton();
            kCamera = constants.new Camera();
            kDrivetrain = constants.new Drivetrain();
        }
