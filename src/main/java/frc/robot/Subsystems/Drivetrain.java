...
public class Drivetrain extends SwerveDrivetrain implements SubsystemBase {
    ...
    private Pose2d blueLob = new Pose2d(.5, 7.1, Rotation2d.fromDegrees(0));
    private Pose2d redLob = new Pose2d(15.7, 7.1, Rotation2d.fromDegrees(180));
    ...
    public void teleLimits(){
        for (int i = 0; i < ModuleCount; i++) {
            ...
            Modules[i].getDriveMotor().getConfigurator().apply(constants.TELE_CURRENT_LIMITS);
    ...
    public void autoLimits(){
        for (int i = 0; i < ModuleCount; i++) {
            ...
            Modules[i].getDriveMotor().getConfigurator().apply(constants.AUTO_CURRENT_LIMITS);
