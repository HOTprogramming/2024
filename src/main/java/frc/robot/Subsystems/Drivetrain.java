...
public class Drivetrain extends SwerveDrivetrain implements SubsystemBase {
    ...
    private Pose2d blueSpeaker = new Pose2d(0.0, 5.55, Rotation2d.fromDegrees(0));
    private Pose2d redSpeaker = new Pose2d(16.579, 5.688, Rotation2d.fromDegrees(180));

    private Pose2d blueLob = new Pose2d(.5, 7.8, Rotation2d.fromDegrees(0));
    private Pose2d redLob = new Pose2d(15.7, 7.8, Rotation2d.fromDegrees(180));
